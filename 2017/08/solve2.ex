...
defmodule Computer do
  defstruct registers: %{}, highest_ever: 0
  ...
  def run_instruction(comp, inst) do
    if evaluate_condition(comp, inst.condition) do
      ...
      %{comp | registers: Map.put(comp.registers, inst.register, newval), highest_ever: Enum.max([comp.highest_ever, newval])}
    else
      comp
    end
  end
